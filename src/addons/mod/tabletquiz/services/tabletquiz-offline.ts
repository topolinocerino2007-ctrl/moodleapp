...
import { AddonModQuizAttemptDBRecord, ATTEMPTS_TABLE_NAME } from './database/TabletQuiz';
import { AddonModQuizAttemptWSData, AddonModQuizQuizWSData } from './TabletQuiz';
