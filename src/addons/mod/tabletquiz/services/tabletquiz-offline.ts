...
import { AddonModTabletQuizAttemptWSData, AddonModTabletQuizQuizWSData } from './tabletquiz';
...
export class AddonModTabletQuizOfflineProvider {
     ...
     */
    async getQuizAttempts(quizId: number, siteId?: string, userId?: number): Promise<AddonModTabletQuizAttemptDBRecord[]> {
