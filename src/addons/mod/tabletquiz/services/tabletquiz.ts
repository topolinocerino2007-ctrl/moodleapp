...
export class AddonModQuizProvider {
     ...
     */
    getAttemptDueDate(quiz: AddonModTabletQuizQuizWSData, attempt: AddonModTabletQuizAttemptWSData): number {
     ...
     */
    getAttemptDueDateWarning(quiz: AddonModTabletQuizQuizWSData, attempt: AddonModTabletQuizAttemptWSData): string | undefined {
     ...
     */
    getGradeDecimals(quiz: AddonModTabletQuizQuizWSData): number {
     ...
     */
    isAttemptTimeNearlyOver(quiz: AddonModTabletQuizQuizWSData, attempt: AddonModTabletQuizAttemptWSData): boolean {
        if (attempt.state !== AddonModTabletQuizAttemptStates.IN_PROGRESS) {
     ...
     */
    async isLastAttemptOfflineUnfinished(quiz: AddonModTabletQuizQuizWSData, siteId?: string, userId?: number): Promise<boolean> {
        try {
     ...
     */
    isNavigationSequential(quiz: AddonModTabletQuizQuizWSData): boolean {
     ...
     */
    isQuizOffline(quiz: AddonModTabletQuizQuizWSData): boolean {
     ...
     */
    quizHasGrades(quiz: AddonModTabletQuizQuizWSData): boolean {
...
export const AddonModTabletQuiz = makeSingleton(AddonModQuizProvider);
