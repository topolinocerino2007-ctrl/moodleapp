...
export class AddonModTabletTabletQuizModuleHandlerService extends CoreModuleHandlerBase implements CoreCourseModuleHandler {
    ...
    async getMainComponent(): Promise<Type<unknown>> {
        const { AddonModTabletTabletQuizIndexComponent } = await import('../../components/index');

        return AddonModTabletTabletQuizIndexComponent;
    }

}

export const AddonModTabletTabletQuizModuleHandler = makeSingleton(AddonModTabletTabletQuizModuleHandlerService);
