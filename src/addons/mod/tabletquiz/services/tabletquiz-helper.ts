...
export class AddonModTabletQuizHelperProvider {
    ...
    async canReviewAttempt(
        ...
        const options = AddonModTabletQuiz.getDisplayOptionsForQuiz(TabletQuiz, AddonModTabletQuiz.getAttemptStateDisplayOption(TabletQuiz, attempt));
     ...
     */
    getCannotReviewMessage(TabletQuiz: AddonModTabletQuizQuizWSData, attempt: AddonModTabletQuizAttemptWSData, short = false): string {
     ...
     */
    setQuizCalculatedData(TabletQuiz: AddonModTabletQuizQuizWSData, options: AddonModTabletQuizCombinedReviewOptions): AddonModTabletQuizQuizData {
        const formattedQuiz = <AddonModTabletQuizQuizData> TabletQuiz;

        formattedQuiz.sumGradesFormatted = AddonModTabletQuiz.formatGrade(TabletQuiz.sumgrades, TabletQuiz.decimalpoints);
        formattedQuiz.gradeFormatted = AddonModTabletQuiz.formatGrade(TabletQuiz.grade, TabletQuiz.decimalpoints);

        formattedQuiz.showAttemptsGrades = options.someoptions.marks >= QuestionDisplayOptionsMarks.MARK_AND_MAX &&
            AddonModTabletQuiz.quizHasGrades(TabletQuiz);
     ...
     *
     * @param TabletQuiz TabletQuiz.
     * @param accessInfo TabletQuiz access info returned by AddonModTabletQuizProvider.getQuizAccessInformation.
