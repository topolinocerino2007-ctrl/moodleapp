 ...
 */
export interface AddonModTabletQuizAccessRuleHandler extends CoreDelegateHandler {
...
export class AddonModTabletQuizAccessRuleDelegateService extends CoreDelegate<AddonModTabletQuizAccessRuleHandler> {
     ...
     */
    getAccessRuleHandler(ruleName: string): AddonModTabletQuizAccessRuleHandler {
     ...
     * @returns Whether it should be displayed.
     */
    shouldShowTimeLeft(rules: string[], attempt: AddonModTabletQuizAttemptWSData, endTime: number, timeNow: number): boolean {
        rules = rules || [];
...
export const AddonModTabletQuizAccessRuleDelegate = makeSingleton(AddonModTabletQuizAccessRuleDelegateService);
