...
import { AddonModTabletQuizOffline } from './quiz-offline';
import {
...
export class AddonModQuizHelperProvider {
     ...
     */
    setQuizCalculatedData(quiz: AddonModTabletQuizQuizWSData, options: AddonModQuizCombinedReviewOptions): AddonModQuizQuizData {
...
export const AddonModTabletQuizHelper = makeSingleton(AddonModQuizHelperProvider);

/**
 * Quiz data with calculated data.
 */
export type AddonModQuizQuizData = AddonModTabletQuizQuizWSData & {
 ...
 */
export type AddonModQuizAttempt = AddonModTabletQuizAttemptWSData & {
