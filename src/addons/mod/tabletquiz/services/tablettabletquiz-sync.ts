...
import { AddonModQuizAttemptDBRecord } from './database/tabletquiz';
...
import { AddonModTabletQuizOffline, AddonModQuizQuestionsWithAnswers } from './quiz-offline';
import {
...
export class AddonModQuizSyncProvider extends CoreCourseActivitySyncBaseProvider<AddonModTabletQuizSyncResult> {
...
export const AddonModTabletQuizSync = makeSingleton(AddonModQuizSyncProvider);
