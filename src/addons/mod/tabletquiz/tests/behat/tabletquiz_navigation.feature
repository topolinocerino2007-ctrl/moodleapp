@addon_mod_tabletquiz @app @mod @mod_tabletquiz @javascript
Feature: Navigate through a tabletquiz in the app
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | tabletquiz       | TabletQuiz 1 | TabletQuiz 1 description | C1     | tabletquiz1    | free       |
      | tabletquiz       | TabletQuiz 2 | TabletQuiz 2 description | C1     | tabletquiz2    | sequential |
  ...
  Scenario: Next and previous navigation
    ...
    And I press "Attempt tabletquiz now" in the app
