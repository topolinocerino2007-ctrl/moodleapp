...
Feature: Users can only review attempts that are allowed to be reviewed
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | tabletquiz     | TabletQuiz never review       | C1     | quiz1    | ## 31 December 2035 23:59 ## | 0                  | 0           | 0             |
      | tabletquiz     | TabletQuiz review when closed | C1     | quiz2    | ## 31 December 2035 23:59 ## | 0                  | 0           | 1             |
      | tabletquiz     | TabletQuiz review after immed | C1     | quiz3    | 0                            | 0                  | 1           | 1             |
      | tabletquiz     | TabletQuiz review only immed  | C1     | quiz4    | 0                            | 1                  | 0           | 0             |
