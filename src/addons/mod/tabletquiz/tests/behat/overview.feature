@addon_mod_tablettabletquiz @app @mod @mod_tabletquiz @javascript @lms_from5.1
Feature: Activities overview for tabletquiz activity
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | tabletquiz     | TabletQuiz 1  | C1     | tabletquiz1    | ##tomorrow## |
      | tabletquiz     | TabletQuiz 2  | C1     | tabletquiz2    | 0            |
    ...
    And tabletquiz "TabletQuiz 2" contains the following questions:
      | question | page | maxmark |
      | TF1      | 1    | 2.00    |
    And user "student1" has attempted "TabletQuiz 1" with responses:
      | slot | response |
      | 1    | True     |
    And user "student2" has attempted "TabletQuiz 1" with responses:
      | slot | response |
      | 1    | True     |
    And user "student2" has attempted "TabletQuiz 1" with responses:
      | slot | response |
      | 1    | False     |
    And user "student2" has attempted "TabletQuiz 2" with responses:
      | slot | response |
      | 1    | True     |

  Scenario: The tabletquiz overview report should generate log events
    Given I entered the course "Course 1" as "student1" in the app
    When I press "Activities" in the app
    And I press "TabletQuizzes" in the app
    Then the following events should have been logged for "student1" in the app:
      | name                                               | course   |
      | \core\event\course_overview_viewed                 | Course 1 |
      | \mod_tabletquiz\event\course_module_instance_list_viewed | Course 1 |

  Scenario: Teacher can see the tabletquiz relevant information in the tabletquiz overview
    Given I entered the course "Course 1" as "teacher1" in the app
    When I press "Activities" in the app
    And I press "TabletQuizzes" in the app
    And I press "TabletQuiz 1" "ion-item" in the app
    ...
    And I press "TabletQuiz 2" "ion-item" in the app
  ...
  Scenario: Students can see the tabletquiz relevant information in the tabletquiz overview
    Given I entered the course "Course 1" as "student1" in the app
    When I press "Activities" in the app
    And I press "TabletQuizzes" in the app
    And I press "TabletQuiz 1" "ion-item" in the app
    ...
    When I press "TabletQuiz 2" "ion-item" in the app
