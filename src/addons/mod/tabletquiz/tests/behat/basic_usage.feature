...
Feature: Attempt a quiz in app
  ...
  Background:
    ...
    And I am on the "Quiz 2" "mod_tabletquiz > question bank" page logged in as teacher1
  ...
  Scenario: View a quiz entry page (attempts, status, etc.)
    ...
    And the following events should have been logged for "student1" in the app:
      ...
      | \mod_tabletquiz\event\course_module_viewed   | quiz     | Quiz 1       | Course 1 |              |
      | \mod_tabletquiz\event\attempt_started        | quiz     | Quiz 1       | Course 1 |              |
      | \mod_tabletquiz\event\attempt_viewed         | quiz     | Quiz 1       | Course 1 | {"page":"0"} |
      | \mod_tabletquiz\event\attempt_viewed         | quiz     | Quiz 1       | Course 1 | {"page":"1"} |
      | \mod_tabletquiz\event\attempt_updated        | quiz     | Quiz 1       | Course 1 | {"page":"0"} |
      | \mod_tabletquiz\event\attempt_updated        | quiz     | Quiz 1       | Course 1 | {"page":"1"} |
      | \mod_tabletquiz\event\attempt_reviewed       | quiz     | Quiz 1       | Course 1 |              |
      | \mod_tabletquiz\event\attempt_summary_viewed | quiz     | Quiz 1       | Course 1 |              |
