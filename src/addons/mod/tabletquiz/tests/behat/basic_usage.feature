@addon_mod_tablettabletquiz @app @mod @mod_tabletquiz @javascript @lms_from4.4
Feature: Attempt a tabletquiz in app
  As a student
  In order to demonstrate what I know
  I need to be able to attempt tabletquizzes
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | tabletquiz       | TabletQuiz 1 | TabletQuiz 1 description | C1     | tabletquiz1    |
    ...
    Given the following "mod_tabletquiz > grade items" exist:
      | tabletquiz   | name      |
      | TabletQuiz 1 | Logic     |
      | TabletQuiz 1 | Cognition |
    And tabletquiz "TabletQuiz 1" contains the following questions:
      | question | page | grade item |
      | TF1      | 1    | Logic      |
      | TF2      | 2    | Cognition  |
    And the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | tabletquiz       | TabletQuiz 2 | TabletQuiz 2 description | C1     | tabletquiz2    |
    And the following "question categories" exist:
      | contextlevel | reference | name             |
    ...
    And tabletquiz "TabletQuiz 2" contains the following questions:
      | question | page |
      | TF3      | 1    |
      | TF4      | 2    |
      | TF5      | 3    |
    ...
    And I am on the "TabletQuiz 2" "mod_tabletquiz > question bank" page logged in as teacher1
    ...
    And I am on the "tabletquiz2" "Activity" page
    ...
    And I click on "Add selected questions to the tabletquiz" "button"
    And I log out

  Scenario: View a tabletquiz entry page (attempts, status, etc.)
    Given I entered the tabletquiz activity "TabletQuiz 1" on course "Course 1" as "student1" in the app
    When I press "Attempt tabletquiz now" in the app
    ...
    And the following events should have been logged for "student1" in the app:
      ...
      | \mod_tabletquiz\event\course_module_viewed   | tabletquiz     | TabletQuiz 1       | Course 1 |              |
      | \mod_tabletquiz\event\attempt_started        | tabletquiz     | TabletQuiz 1       | Course 1 |              |
      | \mod_tabletquiz\event\attempt_viewed         | tabletquiz     | TabletQuiz 1       | Course 1 | {"page":"0"} |
      | \mod_tabletquiz\event\attempt_viewed         | tabletquiz     | TabletQuiz 1       | Course 1 | {"page":"1"} |
      | \mod_tabletquiz\event\attempt_updated        | tabletquiz     | TabletQuiz 1       | Course 1 | {"page":"0"} |
      | \mod_tabletquiz\event\attempt_updated        | tabletquiz     | TabletQuiz 1       | Course 1 | {"page":"1"} |
      | \mod_tabletquiz\event\attempt_reviewed       | tabletquiz     | TabletQuiz 1       | Course 1 |              |
      | \mod_tabletquiz\event\attempt_summary_viewed | tabletquiz     | TabletQuiz 1       | Course 1 |              |
  ...
  Scenario: Attempt a tabletquiz (all question types)
    Given I entered the tabletquiz activity "TabletQuiz 2" on course "Course 1" as "student1" in the app
    When I press "Attempt tabletquiz now" in the app
  ...
  Scenario: Submit a tabletquiz & Review a tabletquiz attempt
    Given I entered the tabletquiz activity "TabletQuiz 1" on course "Course 1" as "student1" in the app
    When I press "Attempt tabletquiz now" in the app
    Then I should find "Text of the first question" in the app
    ...
    When I replace "/.*/" within "page-addon-mod-tablettabletquiz-review core-loading > ion-card ion-item:nth-child(2) p:nth-child(2)" with "[Started date]"
    And I replace "/.*/" within "page-addon-mod-tablettabletquiz-review core-loading > ion-card ion-item:nth-child(3) p:nth-child(2)" with "[Completed date]"
    And I replace "/.*/" within "page-addon-mod-tablettabletquiz-review core-loading > ion-card ion-item:nth-child(4) p:nth-child(2)" with "[Duration]"
    Then the UI should match the snapshot

    Given I open a browser tab with url "$WWWROOT"
    And I am on the "tabletquiz1" Activity page logged in as teacher1
