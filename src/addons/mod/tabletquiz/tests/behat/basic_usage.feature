@addon_mod_tabletquiz @app @mod @mod_tabletquiz @javascript @lms_from4.4
Feature: Attempt a tabletquiz in app
  ...
  Scenario: Submit a tabletquiz & Review a tabletquiz attempt
    ...
    When I replace "/.*/" within "page-addon-mod-tabletquiz-review core-loading > ion-card ion-item:nth-child(2) p:nth-child(2)" with "[Started date]"
    And I replace "/.*/" within "page-addon-mod-tabletquiz-review core-loading > ion-card ion-item:nth-child(3) p:nth-child(2)" with "[Completed date]"
    And I replace "/.*/" within "page-addon-mod-tabletquiz-review core-loading > ion-card ion-item:nth-child(4) p:nth-child(2)" with "[Duration]"
