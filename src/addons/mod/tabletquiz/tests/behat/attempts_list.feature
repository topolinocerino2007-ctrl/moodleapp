...
Feature: View list of attempts in the app
  ...
  Background:
    ...
    And user "student1" has attempted "TabletQuiz 1" with responses:
      | slot | response |
      | 1    | True     |
    And user "student1" has started an attempt at tabletquiz "TabletQuiz 1"
  ...
  Scenario: View abandoned attempts
    Given the attempt at "TabletQuiz 1" by "student1" was never submitted
    And I entered the tabletquiz activity "TabletQuiz 1" on course "Course 1" as "student1" in the app
