...
Feature: Use tabletquizzes with different behaviours in the app
  ...
  Scenario: Adaptive behaviour
    Given the following "activities" exist:
      ...
      | tabletquiz     | TabletQuiz | C1     | tabletquiz     | adaptive           |
    And tabletquiz "TabletQuiz" contains the following questions:
      | question | page |
      | TF1      | 1    |
    And I entered the tabletquiz activity "TabletQuiz" on course "Course 1" as "student1" in the app
  ...
  Scenario: Immediate feedback behaviour
    Given the following "activities" exist:
      ...
      | tabletquiz     | TabletQuiz | C1     | tabletquiz     | immediatefeedback  | 1                |
    And tabletquiz "TabletQuiz" contains the following questions:
      | question | page |
      | TF1      | 1    |
    And I entered the tabletquiz activity "TabletQuiz" on course "Course 1" as "student1" in the app
  ...
  Scenario: Deferred feedback with CBM behaviour
    Given the following "activities" exist:
      | activity | name | course | idnumber | preferredbehaviour |
      | tabletquiz     | TabletQuiz | C1     | tabletquiz     | deferredcbm        |
    And tabletquiz "TabletQuiz" contains the following questions:
      | question | page |
      | TF1      | 1    |
    And I entered the tabletquiz activity "TabletQuiz" on course "Course 1" as "student1" in the app
  ...
  Scenario: Interactive behaviour
    Given the following "activities" exist:
      | activity | name | course | idnumber | preferredbehaviour |
      | tabletquiz     | TabletQuiz | C1     | tabletquiz     | interactive        |
    And tabletquiz "TabletQuiz" contains the following questions:
      | question | page |
      | TF1      | 1    |
    And I entered the tabletquiz activity "TabletQuiz" on course "Course 1" as "student1" in the app
