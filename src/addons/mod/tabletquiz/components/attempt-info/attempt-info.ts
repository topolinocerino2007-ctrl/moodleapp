...
import { AddonModTabletQuiz, AddonModQuizWSAdditionalData } from '../../services/quiz';
import { ADDON_MOD_QUIZ_COMPONENT_LEGACY, AddonModTabletQuizAttemptStates } from '../../constants';
