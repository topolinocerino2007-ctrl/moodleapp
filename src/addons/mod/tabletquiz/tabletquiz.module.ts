...
export async function getModTabletQuizServices(): Promise<Type<unknown>[]> {
    const { AddonModTabletQuizProvider } = await import('./services/tabletquiz');
    const { AddonModTabletQuizOfflineProvider } = await import('./services/tabletquiz-offline');
    const { AddonModTabletQuizHelperProvider } = await import('./services/tabletquiz-helper');
    const { AddonModTabletQuizSyncProvider } = await import('./services/tabletquiz-sync');
    const { AddonModTabletQuizAccessRuleDelegateService } = await import('./services/access-rules-delegate');
