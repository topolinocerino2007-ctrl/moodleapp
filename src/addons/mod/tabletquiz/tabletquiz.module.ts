...
export async function getModQuizServices(): Promise<Type<unknown>[]> {
    const { AddonModTabletQuizProvider } = await import('@addons/mod/tabletquiz/services/quiz');
    const { AddonModTabletQuizOfflineProvider } = await import('@addons/mod/tabletquiz/services/quiz-offline');
    const { AddonModTabletQuizHelperProvider } = await import('@addons/mod/tabletquiz/services/quiz-helper');
    const { AddonModTabletQuizSyncProvider } = await import('@addons/mod/tabletquiz/services/quiz-sync');
