...
export async function getModQuizServices(): Promise<Type<unknown>[]> {
    const { AddonModQuizProvider } = await import('@addons/mod/TabletQuiz/services/TabletQuiz');
    const { AddonModQuizOfflineProvider } = await import('@addons/mod/TabletQuiz/services/TabletQuiz-offline');
    const { AddonModQuizHelperProvider } = await import('@addons/mod/TabletQuiz/services/TabletQuiz-helper');
    const { AddonModQuizSyncProvider } = await import('@addons/mod/TabletQuiz/services/TabletQuiz-sync');
    const { AddonModQuizAccessRuleDelegateService } = await import('@addons/mod/TabletQuiz/services/access-rules-delegate');
