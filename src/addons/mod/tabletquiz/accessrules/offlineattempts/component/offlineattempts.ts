...
import { AddonModTabletQuizAttemptWSData, AddonModTabletQuizQuizWSData } from '@addons/mod/quiz/services/quiz';
import { AddonModTabletQuizSync } from '@addons/mod/quiz/services/quiz-sync';
...
export class AddonModQuizAccessOfflineAttemptsComponent implements OnInit {
    ...
    @Input() quiz?: AddonModTabletQuizQuizWSData; // The quiz the rule belongs to.
    ...
    async ngOnInit(): Promise<void> {
        ...
        const time = await AddonModTabletQuizSync.getSyncTime(this.quiz.id);
