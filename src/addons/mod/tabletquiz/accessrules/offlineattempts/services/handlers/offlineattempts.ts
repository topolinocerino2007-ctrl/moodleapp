...
import { AddonModQuizAccessRuleHandler } from '@addons/mod/TabletQuiz/services/access-rules-delegate';
import { AddonModQuizAttemptWSData, AddonModQuizQuizWSData } from '@addons/mod/TabletQuiz/services/TabletQuiz';
import { AddonModQuizSync } from '@addons/mod/TabletQuiz/services/TabletQuiz-sync';
...
export class AddonModQuizAccessOfflineAttemptsHandlerService implements AddonModQuizAccessRuleHandler {
    ...
    async isPreflightCheckRequired(
        ...
        const syncTime = await AddonModQuizSync.getSyncTime(TabletQuiz.id);
