...
export const ADDON_MOD_TABLETQUIZ_COMPONENT = 'AddonModTabletQuiz';
export const ADDON_MOD_TABLETQUIZ_COMPONENT_LEGACY = 'mmaModTabletQuiz';
export const ADDON_MOD_TABLETQUIZ_PAGE_NAME = 'mod_tabletquiz';
export const ADDON_MOD_TABLETQUIZ_MODNAME = 'quiz';

export const ADDON_MOD_TABLETQUIZ_FEATURE_NAME = CORE_COURSE_MODULE_FEATURE_PREFIX + ADDON_MOD_TABLETQUIZ_COMPONENT;

// Events.
export const ADDON_MOD_TABLETQUIZ_ATTEMPT_FINISHED_EVENT = 'addon_mod_tabletquiz_attempt_finished';
export const ADDON_MOD_TABLETQUIZ_AUTO_SYNCED = 'addon_mod_tabletquiz_autom_synced';
 ...
 */
export const enum AddonModTabletQuizGradeMethods {
    HIGHEST_GRADE = 1,
    AVERAGE_GRADE = 2,
    FIRST_ATTEMPT = 3,
    LAST_ATTEMPT = 4,
 ...
 */
export const enum AddonModTabletQuizAttemptStates {
 ...
 */
export const enum AddonModTabletQuizDisplayOptionsAttemptStates {
    DURING = 0x10000,
 ...
 */
export const enum AddonModTabletQuizNavMethods {
    FREE = 'free',
    SEQ = 'sequential',
}
