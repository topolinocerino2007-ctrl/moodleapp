...
export const ADDON_MOD_QUIZ_COMPONENT = 'AddonModTabletQuiz';
export const ADDON_MOD_QUIZ_COMPONENT_LEGACY = 'mmaModTabletQuiz';
export const ADDON_MOD_QUIZ_PAGE_NAME = 'mod_tabletquiz';
export const ADDON_MOD_QUIZ_MODNAME = 'tabletquiz';
